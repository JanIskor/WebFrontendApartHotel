...
const ApartmentsListPage = () => {
    ...
    const {draft_application_id, apartments_count} = useAppSelector((state) => state.applications)
            ...
            <Row className="mb-5">
                <Col md="6">
                    <Form onSubmit={handleSubmit}>
                        <Row>
                            <Col xs="8">
                                <Input value={apartment_name} onChange={handleChange} placeholder="поиск по названию"></Input>
                            </Col>
                            <Col>
                ...
                {is_authenticated &&
                    <Col className="d-flex flex-row justify-content-end" md="6">
                        <Bin isActive={hasDraft} draft_application_id={draft_application_id} apartments_count={apartments_count} />
                    </Col>
                }
            </Row>
            <Row className="mt-5 d-flex">
                {apartments?.map(apartment => (
                    <Col key={apartment.id} className="mb-4 d-flex justify-content-center" sm="12" md="6" lg="4">
                        <ApartmentCard apartment={apartment} showAddBtn={is_authenticated} />
                    </Col>
                ))}
            </Row>
        </Container>
